...
public class SlidingActivityHelper {
	...
	public void onPostCreate(Bundle savedInstanceState) {
		onPostCreate(savedInstanceState, false);
	}
	 ...
	 * @param savedInstanceState the saved instance state (unused)
	 */
	public void onPostCreate(Bundle savedInstanceState, boolean actionbarOverlay) {
		...
		mSlidingMenu.attachToActivity(mActivity, 
				mEnableSlide ? SlidingMenu.SLIDING_WINDOW : SlidingMenu.SLIDING_CONTENT, actionbarOverlay);
