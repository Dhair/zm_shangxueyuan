...
public class DownloadService extends Service {
    ...
    public void onCreate() {
        ...
        getContentResolver().registerContentObserver(
                Downloads.getAllDownloadsContentURI(getApplicationContext()), true, mObserver);
    ...
    private void updateFromProvider() {
        LogTimber.d("update From Provider");
        synchronized (this) {
            mPendingUpdate = true;
    ...
    private class UpdateThread extends Thread {
        ...
        public void run() {
            LogTimber.d("UpdateThread start runing");
            ...
            for (; ; ) {
                ...
                Cursor cursor = getContentResolver().query(
                        Downloads.getAllDownloadsContentURI(getApplicationContext()), null, null, null,
                        null);
                if (cursor == null) {
                    continue;
                }
...
//                LogTimber.d("mNotifier.updateNotification");
                ...
                for (DownloadInfo info : mDownloads.values()) {
                    if (info.mDeleted) {
                        Helpers.deleteFile(getApplicationContext(),getContentResolver(), info.mId,
    ...
    private void removeSpuriousFiles() {
        ...
        Cursor cursor = getContentResolver().query(
                Downloads.getAllDownloadsContentURI(getApplicationContext()),
