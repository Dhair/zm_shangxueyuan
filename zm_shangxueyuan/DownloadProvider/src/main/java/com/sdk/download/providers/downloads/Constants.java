...
public class Constants {
    ...
    public static final String PACKAGE_NAME = "com.download_sdk.download.provider.android.mapcentral";
     ...
     */
//    public static final String DEFAULT_DL_SUBDIR = (File.separator + ".zuimeia_sdk_download" + File.separator + "OfflineMap" + File.separator + "Maps").toString();
    public static final String DEFAULT_DL_SUBDIR = File.separator + "Android" + File.separator + "data" + File.separator + PACKAGE_NAME + File.separator + "Maps";
    ...
    public static final boolean LOGV = false/**(Config.LOGD && LOCAL_LOGV && Log.isLoggable(TAG, Log.VERBOSE))**/
            ;
