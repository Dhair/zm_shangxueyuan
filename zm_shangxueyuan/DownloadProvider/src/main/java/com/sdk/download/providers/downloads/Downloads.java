...
public final class Downloads implements BaseColumns {
	 ...
	 */
//	public static final String AUTHORITY1 = "com.zuimeia.sdk.download";

	public static String getAuthority(Context mContext) {
		return mContext.getString(R.string.sdk_download_authority);
	}
	 ...
	 * @hide
	 */
	public static final String PERMISSION_ACCESS1 = "com_zuimeia_sdk_download_lib.permission.ACCESS_DOWNLOAD_MANAGER";

	public static String getPremissionAccess(Context mContext) {
		return mContext.getString(R.string.sdk_download_permission_access);
	}
	 ...
	 * @hide
	 */
	public static final String PERMISSION_ACCESS_ADVANCED1 = "com_zuimeia_sdk_download_lib.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

	public static String getPremissionAccessAdvanced(Context mContext) {
		return mContext.getString(R.string.sdk_download_permission_access_advanced);
	}

	/**
	 * The permission to access the all the downloads in the manager.
	 */
	public static final String PERMISSION_ACCESS_ALL1 = "com_zuimeia_sdk_download_lib.permission.ACCESS_ALL_DOWNLOADS";

	public static String getPremissionAccessAll(Context mContext) {
		return mContext.getString(R.string.sdk_download_permission_access_all);
	}
	 ...
	 * @hide
	 */
	public static final String PERMISSION_SEND_INTENTS1 = "com_zuimeia_sdk_download_lib.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

	public static String getPremissionSendIntent(Context mContext) {
		return mContext.getString(R.string.sdk_download_permission_send_download_completed_intents);
	}
	 ...
	 * shown.
	 */
	public static final String PERMISSION_NO_NOTIFICATION1 = "com_zuimeia_sdk_download_lib.permission.DOWNLOAD_WITHOUT_NOTIFICATION";

	public static String getPremissionNoNotification(Context mContext) {
		return mContext.getString(R.string.sdk_download_permission_without_notification);
	}
...
//	public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/my_downloads");
	...
	public static Uri getContentURI(Context mContext) {
		return Uri.parse("content://" + mContext.getString(R.string.sdk_download_authority) + "/my_downloads");
	}
...
//	public static final Uri ALL_DOWNLOADS_CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/all_downloads");
	public static Uri getAllDownloadsContentURI(Context mContext) {
		return Uri.parse("content://" + mContext.getString(R.string.sdk_download_authority) + "/all_downloads");
	}
	/**
	 ...
	 * com.zuimeia_sdk_download.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED.
	 * <p/>
	 * Type: INTEGER
	 * </P>
	 * <p/>
