 ...
 * Copied from packages/apps/Browser.
 */
public class DateSortedExpandableListAdapter extends BaseExpandableListAdapter {
	...
	private class ChangeObserver extends ContentObserver {
		...
		public void onChange(boolean selfChange) {
			Log.e("", "ChangeObserver onChanged");
			refreshData();
		}
	}
	...
	private class MyDataSetObserver extends DataSetObserver {
		...
		public void onChanged() {
			Log.e("", "MyDataSetObserver onChanged");
			buildMap();
	 ...
	 * 
	 * @param groupPosition
	 *            Index of the group containing the desired item.
	 * @param childPosition
	 *            Index of the item within the specified group.
	 * @return boolean False if the cursor is closed, so the Cursor was not
	 *         moved. True on success.
	 */
	/* package */boolean moveCursorToChildPosition(int groupPosition, int childPosition) {
		if (mCursor.isClosed())
			return false;
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		View view;
		if (null == convertView || !(convertView instanceof View)) {
			LayoutInflater factory = LayoutInflater.from(mContext);
			view = factory.inflate(R.layout.sdk_download_list_group_header, null);
		} else {
			view = convertView;
		}
		TextView item = (TextView) view.findViewById(R.id.list_group_text);
		try {
		...
		if (isExpanded) {
			item.setCompoundDrawablesWithIntrinsicBounds(R.drawable.sdk_download_icon_dropdown, 0, 0, 0);
		} else {
			item.setCompoundDrawablesWithIntrinsicBounds(R.drawable.sdk_download_icon_dropup, 0, 0, 0);
		}
